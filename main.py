...
with st.sidebar:
    ...
    n_names = st.radio('Number of names per sex', [1, 5, 10, 15, 20])
...
with tab1:
    ...
    with st.container():
        st.write("Name Trends and One-Hit Wonders")
        fig3 = px.histogram(ohw_data[ohw_data['year'] == year_input], x='name', color='sex')
